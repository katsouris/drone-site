  ...
  return (
    <section id="contact" className="bg-[#f5f2ea] px-5 py-28 text-[#071012] md:px-8">
      <div className="mx-auto grid max-w-7xl gap-14 md:grid-cols-[1fr_0.72fr]">
        <div>
          <p className="mb-5 text-sm uppercase tracking-[0.36em] text-[#087c80]">Η δική σου λήψη</p>
          <motion.h2
          ...
          >
            Φτιάξε την ιστορία σου
          </motion.h2>
          <div className="space-y-3 text-xl">
            <a className="block transition hover:text-[#087c80]" href="mailto:katsourisdimi@gmail.com">
